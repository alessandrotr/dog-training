  ...
  return (
    <figure className={`group relative flex h-full flex-col rounded-2xl border border-stone-200 bg-white p-6 shadow-sm transition-colors hover:border-stone-300 ${className}`}>
      ...
      <div className="mt-5 flex items-end justify-between gap-3 border-t border-stone-100 pt-4">
        {service ? (
          <div className="flex flex-col gap-1.5">
            ...
            <Link
              ...
              className="group/chip relative z-10 inline-flex w-fit items-center gap-1.5 rounded-full bg-stone-100 px-3 py-1.5 font-sans text-xs font-semibold text-stone-700 ring-1 ring-stone-200 transition-colors hover:bg-stone-200/70 hover:text-stone-900"
            >
              {service.title}
        ...
        <span className="inline-flex items-center gap-1 font-mono text-[11px] font-semibold uppercase tracking-wider text-amber-800 transition-transform duration-300 group-hover:translate-x-0.5">
