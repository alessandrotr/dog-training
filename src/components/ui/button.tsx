  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        ctaDots:
          'relative isolate overflow-hidden border-0 bg-clip-border text-white shadow-sm shadow-amber-950/15 ring-1 ring-amber-400/30 transition-[filter,box-shadow] hover:shadow-md hover:brightness-105 [background-image:radial-gradient(circle,rgba(255,255,255,0.08)_1.5px,transparent_1.5px),linear-gradient(to_bottom_right,var(--color-amber-500),var(--color-amber-600),var(--color-amber-800))] [background-size:16px_16px,100%_100%]',
      },
      size: {
        default:
...
function Button({
  ...
  return (
    <ButtonPrimitive
      data-slot="button"
      render={render}
      // When rendered as a link/other element (via `render`), it's not a native
      // <button> — tell Base UI so it drops native-button semantics & the warning.
