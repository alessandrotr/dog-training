...
export default function Text({as: Tag = 'p', size = 'sm', tone = 'muted', className, ...rest}: TextProps) {
  return <Tag className={cn('font-sans leading-relaxed', SIZES[size], TONES[tone], className)} {...rest} />;
}
