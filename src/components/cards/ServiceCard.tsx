...
import { Card, CardStat, PriceTag, Heading, Text } from '@/components/ui'
    ...
    >
        ...
        <button
          ...
          className={`absolute top-3 right-3 flex h-8 w-8 items-center justify-center rounded-full shadow-sm backdrop-blur transition-colors ${
            added
              ...
              : 'bg-white/95 text-stone-600 hover:bg-white hover:text-amber-800'
          }`}
        >
      ...
      <div className="flex flex-1 flex-col p-5 text-left">
        ...
        <Heading
          level={3}
          size="card"
          className="mt-2.5 transition-colors group-hover:text-amber-900"
        >
          {svc.title}
        </Heading>
